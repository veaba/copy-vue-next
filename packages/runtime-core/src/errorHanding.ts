...
export const ErrorTypeStrings: Record<number | string, string> = {
    ...
    [LifecycleHooks.ACTIVATED]: 'activate hook',
    [LifecycleHooks.DEACTIVATED]: 'deactivate hook',
    ...
    [ErrorCodes.TRANSITION_HOOK]: 'translation hook',
